...
public struct Unicode
{
	 ...
	 */
	public static wchar* ucs4ToUtf16(dchar[] str, out glong itemsRead, out glong itemsWritten)
	{
		GError* err = null;

		auto __p = g_ucs4_to_utf16(str.ptr, cast(glong)str.length, &itemsRead, &itemsWritten, &err);
	 ...
	 * Throws: GException on failure.
	 */
	public static string ucs4ToUtf8(dchar[] str, out glong itemsRead, out glong itemsWritten)
	{
		GError* err = null;

		auto retStr = g_ucs4_to_utf8(str.ptr, cast(glong)str.length, &itemsRead, &itemsWritten, &err);
	 ...
	 */
	public static void unicodeCanonicalOrdering(dchar[] string_)
	{
		g_unicode_canonical_ordering(string_.ptr, cast(size_t)string_.length);
	}
	 ...
	 * Throws: GException on failure.
	 */
	public static dchar* utf16ToUcs4(wchar[] str, out glong itemsRead, out glong itemsWritten)
	{
		GError* err = null;

		auto __p = g_utf16_to_ucs4(str.ptr, cast(glong)str.length, &itemsRead, &itemsWritten, &err);
	 ...
	 * Throws: GException on failure.
	 */
	public static string utf16ToUtf8(wchar[] str, out glong itemsRead, out glong itemsWritten)
	{
		GError* err = null;

		auto retStr = g_utf16_to_utf8(str.ptr, cast(glong)str.length, &itemsRead, &itemsWritten, &err);
