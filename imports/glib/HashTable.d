...
public class HashTable
{
	 ...
	 *
	 * Returns: a #GPtrArray containing each key from
	 *     the table. Unref with with g_ptr_array_unref() when done.
	 *
	 * Since: 2.76
	 */
	public PtrArray getKeysAsPtrArray()
	{
		auto __p = g_hash_table_get_keys_as_ptr_array(gHashTable);
	 ...
	 * You should always unref the returned array with g_ptr_array_unref().
	 *
	 * Returns: a #GPtrArray containing each value from
	 *     the table. Unref with with g_ptr_array_unref() when done.
	 *
	 * Since: 2.76
	 */
	public PtrArray getValuesAsPtrArray()
	{
		auto __p = g_hash_table_get_values_as_ptr_array(gHashTable);
	 ...
	 * destroy function.
	 *
	 * Returns: a #GPtrArray containing each key of
	 *     the table. Unref with with g_ptr_array_unref() when done.
	 *
	 * Since: 2.76
	 */
	public PtrArray stealAllKeys()
	{
		auto __p = g_hash_table_steal_all_keys(gHashTable);
	 ...
	 * destroy function.
	 *
	 * Returns: a #GPtrArray containing each value of
	 *     the table. Unref with with g_ptr_array_unref() when done.
	 *
	 * Since: 2.76
	 */
	public PtrArray stealAllValues()
	{
		auto __p = g_hash_table_steal_all_values(gHashTable);
