...
struct GFileIface
{
	...
	/** */
	extern(C) void function(GFile* file, char* symlinkValue, int ioPriority, GCancellable* cancellable, GAsyncReadyCallback callback, void* userData) makeSymbolicLinkAsync;
	/**
	 *
	 * Params:
	 *     file = input #GFile
	 ...
	 * Throws: GException on failure.
	 */
	extern(C) int function(GFile* file, GAsyncResult* result, GError** err) makeSymbolicLinkFinish;
	/**
	 *
	 * Params:
	 *     source = input #GFile
...
struct GIconIface
{
	 ...
	 *     outVersion = version of serialized tokens
 ...
 */
public alias extern(C) void function(GObject* sourceObject, GAsyncResult* res, void* data) GAsyncReadyCallback;
 ...
 * Since: 2.28
 */
public alias extern(C) int function(GCancellable* cancellable, void* data) GCancellableSourceFunc;
 ...
 * Since: 2.30
 */
public alias extern(C) GType function(GDBusObjectManagerClient* manager, const(char)* objectPath, const(char)* interfaceName, void* data) GDBusProxyTypeFunc;
 ...
 * Since: 2.48
 */
public alias extern(C) int function(GDatagramBased* datagramBased, GIOCondition condition, void* data) GDatagramBasedSourceFunc;
 ...
 * Since: 2.38
 */
public alias extern(C) void function(int reporting, ulong currentSize, ulong numDirs, ulong numFiles, void* data) GFileMeasureProgressCallback;
 ...
 *     data = user data passed to the callback.
 */
public alias extern(C) void function(long currentNumBytes, long totalNumBytes, void* data) GFileProgressCallback;
 ...
 */
public alias extern(C) int function(GIOSchedulerJob* job, GCancellable* cancellable, void* data) GIOSchedulerJobFunc;
 ...
 * Since: 2.28
 */
public alias extern(C) int function(GObject* pollableStream, void* data) GPollableSourceFunc;
 ...
 * Since: 2.22
 */
public alias extern(C) int function(GSocket* socket, GIOCondition condition, void* data) GSocketSourceFunc;
...
alias G_FILE_ATTRIBUTE_THUMBNAILING_FAILED_LARGE = FILE_ATTRIBUTE_THUMBNAILING_FAILED_LARGE;
...
alias G_FILE_ATTRIBUTE_THUMBNAILING_FAILED_NORMAL = FILE_ATTRIBUTE_THUMBNAILING_FAILED_NORMAL;
...
alias G_FILE_ATTRIBUTE_THUMBNAILING_FAILED_XLARGE = FILE_ATTRIBUTE_THUMBNAILING_FAILED_XLARGE;
...
alias G_FILE_ATTRIBUTE_THUMBNAILING_FAILED_XXLARGE = FILE_ATTRIBUTE_THUMBNAILING_FAILED_XXLARGE;
...
alias G_FILE_ATTRIBUTE_THUMBNAIL_IS_VALID_LARGE = FILE_ATTRIBUTE_THUMBNAIL_IS_VALID_LARGE;
...
alias G_FILE_ATTRIBUTE_THUMBNAIL_IS_VALID_NORMAL = FILE_ATTRIBUTE_THUMBNAIL_IS_VALID_NORMAL;
...
alias G_FILE_ATTRIBUTE_THUMBNAIL_IS_VALID_XLARGE = FILE_ATTRIBUTE_THUMBNAIL_IS_VALID_XLARGE;
...
alias G_FILE_ATTRIBUTE_THUMBNAIL_IS_VALID_XXLARGE = FILE_ATTRIBUTE_THUMBNAIL_IS_VALID_XXLARGE;
...
alias G_FILE_ATTRIBUTE_THUMBNAIL_PATH_LARGE = FILE_ATTRIBUTE_THUMBNAIL_PATH_LARGE;
...
alias G_FILE_ATTRIBUTE_THUMBNAIL_PATH_NORMAL = FILE_ATTRIBUTE_THUMBNAIL_PATH_NORMAL;
...
alias G_FILE_ATTRIBUTE_THUMBNAIL_PATH_XLARGE = FILE_ATTRIBUTE_THUMBNAIL_PATH_XLARGE;
...
alias G_FILE_ATTRIBUTE_THUMBNAIL_PATH_XXLARGE = FILE_ATTRIBUTE_THUMBNAIL_PATH_XXLARGE;
...
alias G_FILE_ATTRIBUTE_TIME_ACCESS_NSEC = FILE_ATTRIBUTE_TIME_ACCESS_NSEC;
...
alias G_FILE_ATTRIBUTE_TIME_CHANGED_NSEC = FILE_ATTRIBUTE_TIME_CHANGED_NSEC;
...
alias G_FILE_ATTRIBUTE_TIME_CREATED_NSEC = FILE_ATTRIBUTE_TIME_CREATED_NSEC;
...
alias G_FILE_ATTRIBUTE_TIME_MODIFIED_NSEC = FILE_ATTRIBUTE_TIME_MODIFIED_NSEC;
...
alias G_MENU_EXPORTER_MAX_SECTION_SIZE = MENU_EXPORTER_MAX_SECTION_SIZE;
