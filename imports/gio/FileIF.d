...
public interface FileIF{
	 ...
	 * Since: 2.74
	 */
	public static void newTmpAsync(string tmpl, int ioPriority, Cancellable cancellable, GAsyncReadyCallback callback, void* userData)
	{
		g_file_new_tmp_async(Str.toStringz(tmpl), ioPriority, (cancellable is null) ? null : cancellable.getCancellableStruct(), callback, userData);
	}
	 ...
	 * Since: 2.74
	 */
	public static void newTmpDirAsync(string tmpl, int ioPriority, Cancellable cancellable, GAsyncReadyCallback callback, void* userData)
	{
		g_file_new_tmp_dir_async(Str.toStringz(tmpl), ioPriority, (cancellable is null) ? null : cancellable.getCancellableStruct(), callback, userData);
	}
	 ...
	 * Since: 2.74
	 */
	public void makeSymbolicLinkAsync(string symlinkValue, int ioPriority, Cancellable cancellable, GAsyncReadyCallback callback, void* userData);
	 ...
	 * Throws: GException on failure.
	 */
	public bool makeSymbolicLinkFinish(AsyncResultIF result);
