...
public template FileT(TStruct)
{
	...
	{
		g_file_make_symbolic_link_async(getFileStruct(), Str.toStringz(symlinkValue), ioPriority, (cancellable is null) ? null : cancellable.getCancellableStruct(), callback, userData);
	}
	...
	public bool makeSymbolicLinkFinish(AsyncResultIF result)
	{
		...
		auto __p = g_file_make_symbolic_link_finish(getFileStruct(), (result is null) ? null : result.getAsyncResultStruct(), &err) != 0;
