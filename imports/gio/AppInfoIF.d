...
public interface AppInfoIF{
	 ...
	 * Since: 2.74
	 */
	public static void getDefaultForTypeAsync(string contentType, bool mustSupportUris, Cancellable cancellable, GAsyncReadyCallback callback, void* userData)
	{
		g_app_info_get_default_for_type_async(Str.toStringz(contentType), mustSupportUris, (cancellable is null) ? null : cancellable.getCancellableStruct(), callback, userData);
	}
	 ...
	 * Throws: GException on failure.
	 */
	public static AppInfoIF getDefaultForTypeFinish(AsyncResultIF result)
	{
		GError* err = null;

		auto __p = g_app_info_get_default_for_type_finish((result is null) ? null : result.getAsyncResultStruct(), &err);
	 ...
	 * Since: 2.74
	 */
	public static void getDefaultForUriSchemeAsync(string uriScheme, Cancellable cancellable, GAsyncReadyCallback callback, void* userData)
	{
		g_app_info_get_default_for_uri_scheme_async(Str.toStringz(uriScheme), (cancellable is null) ? null : cancellable.getCancellableStruct(), callback, userData);
	}
	 ...
	 * Throws: GException on failure.
	 */
	public static AppInfoIF getDefaultForUriSchemeFinish(AsyncResultIF result)
	{
		GError* err = null;

		auto __p = g_app_info_get_default_for_uri_scheme_finish((result is null) ? null : result.getAsyncResultStruct(), &err);
